...
# Read the authentication keys for Alpaca from environment variables.
ALPACA_CLIENT_ID = getenv('ALPACA_CLIENT_ID')
ALPACE_CLIENT_SECRET = getenv('ALPACA_CLIENT_SECRET')
